...
You will also need to have the Hominid gem or plugin installed. You can install as a plugin using <code>script/plugin install git://github.com/bgetting/hominid.git</code>, or as a GemPlugin (recommended) by including the following in your **environment.rb** file:
